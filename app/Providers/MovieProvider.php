...
/**
 * @author Larry Barker <larry@larrybarker.me>
 * @see https://github.com/JulienRAVIA/FakerCinemaProviders
 */
class MovieProvider extends Base
{
    ...
    {
        return static::randomElement(static::$ratings);
    }
    ...
    {
        return $this->generator->realText(mt_rand(100, 250));
    }
